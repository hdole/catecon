...
//
Diagram.prototype.CanEvaluate(obj)
{
	return ProductObject.isPrototypeOf(obj) && obj.objects.length === 2 && HomObject.isPrototypeOf(obj.objects[0]) && obj.objects[0].objects[0].isEquivalent(obj.objects[1]);
}
